...
namespace Sugestoes_02_01.DAO
{
    ...
    /// </summary>
    public class SugestoesDAO : NativeDAO<Sugestoes>, IBaseDAO<Sugestoes, int>
    {
        /// <summary>
        ...
        public SugestoesDAO(System.Data.IDbConnection connection, ObjectSecurity objectSecurity) : base(connection, objectSecurity)
        {
        }
        ...
        /// <returns>Objeto Inserido</returns>
        public Sugestoes InsertByStoredProcedure(Sugestoes pObject)
        {
